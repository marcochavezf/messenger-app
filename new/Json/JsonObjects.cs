...
namespace Kangou.Json {
	...
	public class Files {
		[JsonProperty("identification")] public List<string> Identification { get; set; }

		[JsonProperty("addressProof")] public List<string> AddressProof { get; set; }
	}
	...
	public class DataCourier {
		...
		[JsonProperty("phoneOperativeSystem")] public string PhoneOperativeSystem { get; set; }

		[JsonProperty("transportation")] public string Transportation { get; set; }

		[JsonProperty("files")] public Files Files { get; set; }

		[JsonProperty("cardToDeposit")] public CardToDeposit CardToDeposit { get; set; }
	}
	...
	public class LegalAddress {
		...
		[JsonProperty("apartmentNumber")] public string ApartmentNumber { get; set; }

		[JsonProperty("streetNumber")] public string StreetNumber { get; set; }

		[JsonProperty("sublocality")] public string Sublocality { get; set; }

		[JsonProperty("administrativeArea")] public string AdministrativeArea { get; set; }

		[JsonProperty("country")] public string Country { get; set; }

		[JsonProperty("isoCountry")] public string IsoCountry { get; set; }
